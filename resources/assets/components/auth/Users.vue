      ...
      <div class="table-shadow row" id="users">
        ...
        <div class="d-flex justify-content-between align-items-center w-100">
          ...
          <div class="export" v-if="!isLoadingExport && false">
            <div class="pdf" @click="tableExport('usersDetail', 'pdf')" :title="$t('GENERAL.pdfExport')"></div>
            <div class="excel" @click="tableExport('usersDetail', 'xls')" :title="$t('GENERAL.excelExport')"></div>
            <div class="csv" @click="tableExport('usersDetail', 'csv')" :title="$t('GENERAL.csvExport')"></div>
          </div>
