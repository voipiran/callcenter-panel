...
// Find out how many calls can be made (by prediction), and take
// the lesser value of max campaign and predictive.
...
//AGENTES_LIBRES 
//AGENTES_POR_DESOCUPAR   AGENTS TO VACATE
//CLIENTES_ESPERA    CUSTOMERS WAITING
//iMaxPredecidos  iMax Predicted
/*VOIPIRAN*/
/*Remove Free Agent Check*/
        //$iMaxPredecidos = $resumenPrediccion['AGENTES_POR_DESOCUPAR'] - $resumenPrediccion['CLIENTES_ESPERA'];
...
//iNumLlamadasColocar    iNum Calls Place
		...
		/*VOIPIRAN*/
		$iNumLlamadasColocar = 99999;
		//TODO: put agent conflict detection code
...
/*VOIPIRAN*/
/*there are no free agents or ready*/
...
/*Originate*/
/*VOIPIRAN*/
// Have the call run through AMIEventProcess
            // Mandar a ejecutar la llamada a través de AMIEventProcess
			$sCadenaVar="CDR(accountcode)=Dialer";
...
/* If this point is reached, it is assumed that, with agents available, and
          * campaign active, calls ended. Therefore the campaign
          * already done */
