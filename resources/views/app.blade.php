            ...
            <header class="header">
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <!--logo start-->
                        @if (isset($aboutMe))
                            <a href="{{ $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . config('app.API') . '/' }}" class="logo"> {{ $aboutMe['header'] }}</a>
                        @else
                            <a href="{{ $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . config('app.API') . '/' }}" class="logo">Voip<span>Iran</span></a>
                        @endif
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex align-items-center pt-1">
                            ...
                            <div class="custom-icon edit" @click="$router.push({ name: 'users_edit', params: { 'id': 0 } })">
            ...
            <aside>
                <div id="sidebar" class="nav-collapse">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        <li v-for="(menu,index) in menus" @click="showActiveMenu(menu.route)" :class="{ 'd-none': !menu.licence }">
                            {{-- main menu --}}
                            <router-link tag="a" v-if="menu.route" :to="menu.route" :class="{ 'active': menu.visable }">
                                <i :class="menu.icon"></i>
                                <span class="p-2">@{{ $t(menu.content) }}</span>

                                {{-- sub menu --}}
                                <ul class="sub-menu" v-if="menu.children" :class="{ 'active-sub-menu': menu.visable }">
                                    <li v-for="(subMenu,index) in menu.children" :class="{ 'd-none': !subMenu.licence }">
                    ...
                    <div class="modal-wrapper">
                        <div class="modal-container">
                            ...
                            <div class="modal-footer-content mt-3">
                                ...
                                <div class="d-flex align-items-center">
                                    {{-- instagram --}}
                                    <a href="https://www.instagram.com/{{ $aboutMe['icon']['insta'] }}/" target="_blank" rel="noopener noreferrer">
                                    ...
                                    {{-- telegram --}}
                                    <a href="https://t.me/{{ $aboutMe['icon']['telegram'] }}" target="_blank" rel="noopener noreferrer">
                                        <div class="socail-media-item">
                                            <svg width="25" height="25" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
